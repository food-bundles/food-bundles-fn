  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      const combinedStats: DashboardStats = {
        ...
        finance: financeRes.status === 'fulfilled' ? financeRes.value.data : { totalRevenue: 0, totalExpenses: 0, netProfit: 0, profitMargin: 0, timeSeriesData: [], revenueBreakdown: { orders: 0, subscriptions: 0, vouchers: 0 }, expenseBreakdown: { usedVouchers: 0, maturedVouchers: 0, nearMaturityVouchers: 0, farmerPayments: 0 }, timeBreakdown: {} },
