...
export function ViewOrderModal({ open, onOpenChange, order }: ViewOrderModalProps) {
  const handleDownload = () => {
    ...
    try {
      ...
      doc.setTextColor(100, 116, 139);
      doc.setFontSize(16);
      doc.text(order.originalData?.paymentMethod || order.paymentMethod || "N/A", 105, yPos + 8, { align: "center" });
      ...
      doc.setFont("helvetica", "normal");
      doc.setFontSize(16);
      doc.text("Thank you for choosing Food Bundle!", 105, yPos + 12, {
        align: "center",
      });
      doc.text(`Generated on ${new Date().toLocaleString()}`, 105, yPos + 22, {
        align: "center",
      });
