    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          ...
          >
            <span
              className={`w-1.5 h-1.5 rounded-full ${voucher.status === "ACTIVE" ? "bg-green-500" : "bg-gray-400"
                }`}
            ></span>
            {voucher.status}
          </span>
          ...
          <div className="flex items-center justify-start gap-2">
            {needsPayment && (
              <button
                ...
                className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${payingVoucherId === voucher.id
