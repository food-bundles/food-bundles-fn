    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <p className="text-xs font-medium text-gray-600">
          Prefer instant help? Use our AI agent, bottom right corner.
        </p>
      </div>
    </div>
  );
      ...
      {!isChatOpen && (
        <div className="fixed bottom-12 right-6 z-40 flex flex-col items-end gap-3">
          ...
          <button
            ...
            className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 text-white shadow-lg hover:scale-110 transition-transform"
            aria-label="Chat with AI agent"
          >
            <BsFillChatRightQuoteFill className="h-5 w-5 md:h-6 md:w-6" />
            <span className="pointer-events-none absolute right-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-xs font-medium text-white bg-gray-900/90 rounded-md px-2 py-1">
              Ask our AI agent
            </span>
          </button>
          ...
          <button
            ...
            className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg hover:scale-110 transition-transform"
